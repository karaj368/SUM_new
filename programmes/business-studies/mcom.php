...
<head>
    ...
    <title>Top M.Com. Program | Shobhit University | Apply Now</title>
                ...
                <div class="col-lg-8">
                    <div class="courses-details">
                        <div class="header-title about-courses-rebbon">
                            ...
                            <h1 data-aos="fade-up" data-aos-delay="100">M.Com. Program </h1>
                        ...
                        <div class="content">
                            <div class="content-pra">
                                <div class="title">
                                    ...
                                    <p>Commerce education has been a well-respected career option for a long. The day-to-day expansion of the trade and commerce world is responsible for making this study more relevant and sought after.</p>
                                    <p>The new age of commerce education is also constantly fine-tuning itself in line with the ongoing changes happening in the trade and business world. University offers commerce education at both undergraduate and postgraduate levels.</p>
                                    <p>M.Com. degree not only grooms the student with masterly skills in the area of Accountancy, Management Accountancy, and Finance but also sets them towards a teaching and research career in Commerce.</p>
                                </div>
                            ...
                            <div class="content-pra">
                                <div class="title">
                                    <h2>Why choose <span style="color:#116446;">Shobhit University</span> for your <span
                                            style="color:#116446;">M.Com.?</span></h2>
                                </div>
                                ...
                                <p class="fw-bold fs-5" style="color:#f69527;">Shobhit Edge</p>
                                 <ul class="lists mb-3">
                                    ...
                                    <li>
                                     ...
                                     <p>Hi-Tech Wi-fi enabled campus</p>
                                    </li>
                                    <li>
                                        <div class="icon">
                                            <i class='bx bx-check'></i>
                                        </div>
                                   <p>Start-up Funding Opportunities</p>
                                    </li>
                                    <li>
                                        <div class="icon">
                                            <i class='bx bx-check'></i>
                                    ...
                                    <p>Cutting edge academic programs in partnership with industry leaders</p>
                                    </li>
                            ...
                            <div class="content-pra">
                                ...
                                <ul class="lists mb-5">
                                    <li>
                                     ...
                                     <p>Students who’ve completed Graduation from a recognized university are eligible</p>
                                    </li>
                                    <li>
                                        <div class="icon">
                                            <i class='bx bx-check'></i>
