...
<head>
  ...
  <title>Research Activities | Shobhit University</title>
    ...
    <div class="container">
      <div class="banner-spacing">
        <div class="section-info">
          <h1 data-aos="fade-up" data-aos-delay="100"> Research Activities </h1>
        ...
        <div class="col-lg-9">
          <div class="ac-overview">
            <div class="pera-dec">
              ...
              <p><a href="https://www.shobhituniversity.ac.in/pdf/ssr/c3/collaborative-research-activities.pdf" target="_blank"><strong>Collaborative Research Activities</strong></a></p>
            </div>
          </div>
        </div>
        <div class="col-lg-3">
