...
<head>
  ...
  <title>Media Coverage | Shobhit University</title>
    ...
    <div class="container">
      <div class="banner-spacing">
        <div class="section-info">
          <h1 data-aos="fade-up" data-aos-delay="100"> Media Coverage</h1>
            ...
            <div class="ac-category">
              ...
              <ul>
                ...
                <li><a href="image-gallery.php" title="Image Gallery">Image
                    Gallery</a></li>
                <li><a class="active" href="media-coverage.php" title="Media Coverage">Media
                    Coverage</a></li>
