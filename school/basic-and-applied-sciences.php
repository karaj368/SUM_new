...
<head>
    ...
    <title>School of Basic & Applied Sciences in Meerut | Shobhit University</title>

    <?php include '../header.php';?>
    <!-- Start Section Banner Area -->
    <section class="section-banner bg-1 schoolEng-tech">
        <div class="container">
                ...
                <div class="col-lg-8">
                    <div class="courses-details">
                        <div class="header-title about-courses-rebbon">
                            ...
                            <h1 data-aos="fade-up" data-aos-delay="100">School of Basic & Applied Sciences </h1>
                        ...
                        <div class="content">
                            <div class="content-pra">
                                ...
                                <p>The course contents broadly cover fields: Physiological signal processing, medical imcbeng, medical
                                     image processing, biomaterials, biomechanics and bioengineering, system analysis, bio-compatible 
                                     medical devices and diagnostic devices. The program imparts training to students to assimilate 
                                     knowledge of engineering design and development of medical instruments in medical sciences and
                                      hospitals. The course strengthens the manpower in area of biomedical engineering, thus forming 
                                      a essential knowledge base between engineering principle, techniques and medical sciences for
                                       research and development in the service of society and mankind.</p>
                            ...
                            <div class="content-pra">
                                ...
                                <p class="fw-bold fs-5" style="color:#f69527;">The programmes under School of Basic & Applied Sciences are designed to enable students to</p>
                            ...
                            <div class="tab-pane fade show active" id="one-tab-pane" role="tabpanel"
                                ...
                                <div class="specialization-grid">
                                    <div class="row gy-3 py-md-4 text-center">
                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-3 spec-grid"><a href="<?php echo $base_url;?>programmes/engineering/btech.php"> <img
                                                src="<?php echo $base_url;?>assets/img/specialization/btech/csc-eng.webp"
                                                alt=""></a></div>
                                        <div class="col-sm-6 col-md-4 col-lg-3 spec-grid"><a href="<?php echo $base_url;?>programmes/engineering/btech.php"> <img
                                                src="<?php echo $base_url;?>assets/img/specialization/btech/Agri-tech.webp"
                                                alt=""></a></div>
                                        <div class="col-sm-6 col-md-4 col-lg-3 spec-grid"><a href="<?php echo $base_url;?>programmes/engineering/btech.php"> <img
                                                src="<?php echo $base_url;?>assets/img/specialization/btech/biomed-tech.webp"
                                                alt=""></a></div>
                                        <div class="col-sm-6 col-md-4 col-lg-3 spec-grid"><a href="<?php echo $base_url;?>programmes/engineering/btech.php"> <img
                                                src="<?php echo $base_url;?>assets/img/specialization/btech/biotech-eng.webp"
                                                alt=""></a></div>
                            ...
                            <div class="tab-pane fade" id="two-tab-pane" role="tabpanel" aria-labelledby="two-tab"
                                ...
                                <div class="specialization-grid">
                                    <div class="row justify-content-center gy-3 py-md-4 text-center">
                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-3 spec-grid"><a href="<?php echo $base_url;?>programmes/engineering/bca.php"> <img
                                                src="<?php echo $base_url;?>assets/img/specialization/bca/bca1.webp"
                                                alt=""></a></div>
                                        <div class="col-sm-6 col-md-4 col-lg-3 spec-grid"><a href="<?php echo $base_url;?>programmes/engineering/bca.php"> <img
                                                src="<?php echo $base_url;?>assets/img/specialization/bca/bca2.webp"
                                                alt=""></a></div>
                                        <div class="col-sm-6 col-md-4 col-lg-3 spec-grid"><a href="<?php echo $base_url;?>programmes/engineering/bca.php"> <img
                                                src="<?php echo $base_url;?>assets/img/specialization/bca/bca3.webp"
                                                alt=""></a></div>
                                        <div class="col-sm-6 col-md-4 col-lg-3 spec-grid"><a href="<?php echo $base_url;?>programmes/engineering/bca.php"> <img
                                                src="<?php echo $base_url;?>assets/img/specialization/bca/bca4.webp"
                                                alt=""></a></div>
                                        <div class="col-sm-6 col-md-4 col-lg-3 spec-grid"><a href="<?php echo $base_url;?>programmes/engineering/bca.php"> <img
                                                src="<?php echo $base_url;?>assets/img/specialization/bca/bca5.webp"
                                                alt=""></a></div>
                            ...
                            <div class="tab-pane fade" id="three-tab-pane" role="tabpanel" aria-labelledby="three-tab"
                                ...
                                <div class="specialization-grid">
                                    <div class="row gy-3 py-md-4 text-center">
                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-3 spec-grid"> <a href="<?php echo $base_url;?>programmes/engineering/mtech.php"> <img
                                                src="<?php echo $base_url;?>assets/img/specialization/mtech/spec1.webp"
                                                alt=""></a></div>
                                        <div class="col-sm-6 col-md-4 col-lg-3 spec-grid"> <a href="<?php echo $base_url;?>programmes/engineering/mtech.php"><img
                                                src="<?php echo $base_url;?>assets/img/specialization/mtech/spec02.png"
                                                alt=""></a></div>
                                        <div class="col-sm-6 col-md-4 col-lg-3 spec-grid"> <a href="<?php echo $base_url;?>programmes/engineering/mtech.php"><img
                                                src="<?php echo $base_url;?>assets/img/specialization/mtech/spec3.webp"
                                                alt=""></a></div>
                                        <div class="col-sm-6 col-md-4 col-lg-3 spec-grid"> <a href="<?php echo $base_url;?>programmes/engineering/mtech.php"><img
                                                src="<?php echo $base_url;?>assets/img/specialization/mtech/spec4.webp"
                                                alt=""></a></div>
                            ...
                            <div class="tab-pane fade" id="four-tab-pane" role="tabpanel" aria-labelledby="four-tab"
                                ...
                                <div class="specialization-grid">
                                    <div class="row justify-content-center gy-3 py-md-4 text-center">
                                          ...
                                          <div class="col-sm-6 col-md-4 col-lg-3 spec-grid"> <a href="<?php echo $base_url;?>programmes/engineering/mca.php"><img
                                                src="<?php echo $base_url;?>assets/img/specialization/mca/spec1.webp"
                                                alt=""></a></div>
                                        <div class="col-sm-6 col-md-4 col-lg-3 spec-grid"> <a href="<?php echo $base_url;?>programmes/engineering/mca.php"> <img
                                                src="<?php echo $base_url;?>assets/img/specialization/mca/spec2.webp"
                                                alt=""></a></div>
                                        <div class="col-sm-6 col-md-4 col-lg-3 spec-grid"> <a href="<?php echo $base_url;?>programmes/engineering/mca.php"> <img
                                                src="<?php echo $base_url;?>assets/img/specialization/mca/spec3.webp"
                                                alt=""></a></div>
                                        <div class="col-sm-6 col-md-4 col-lg-3 spec-grid"> <a href="<?php echo $base_url;?>programmes/engineering/mca.php"> <img
                                                src="<?php echo $base_url;?>assets/img/specialization/mca/spec4.webp"
                                                alt=""></a></div>
                                        <div class="col-sm-6 col-md-4 col-lg-3 spec-grid"> <a href="<?php echo $base_url;?>programmes/engineering/mca.php"> <img
                                                src="<?php echo $base_url;?>assets/img/specialization/mca/spec5.webp"
                                                alt=""></a></div>
