                    ...
                    <div class="courses-details">
                        ...
                        <div class="content">
                            <div class="content-pra">
                                <!-- <img src="<?php echo $base_url;?>assets/img/biological.webp" class=" rounded-5" width="100%" alt="School of Engineering and Technology"> -->
                            ...
                            <div class="tab-pane fade" id="three-tab-pane" role="tabpanel" aria-labelledby="three-tab"
                                ...
                                <div class="specialization-grid">
                                    <div class="row justify-content-center gy-3 py-md-4 text-center">
                                        ...
                                        <div class="col-sm-6 col-md-4 col-lg-3 spec-grid"> <a href="<?php echo $base_url;?>programmes/research/phd.php"> <img
                                                src="<?php echo $base_url;?>assets/img/specialization/phd/Phd.png"
                                                alt=""></a></div>
