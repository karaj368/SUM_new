...
<head>
  ...
  <title> Fee Structure | Shobhit University</title>
    ...
    <div class="container">
      <div class="banner-spacing">
        <div class="section-info">
          ...
          <h1 data-aos="fade-up" data-aos-delay="100"> Fee Structure </h1>
      ...
      <div class="row">
        <div class="col-lg-9">
          <div class="ac-overview">
            <div class="pera-dec">
            <img src="./assets/img/FEE_STRUCTURE_2025-26.jpg" alt="Fee Structure" class="w-100">
            <img src="./assets/img/FEE_STRUCTURE_2025-26-2.jpg" alt="Fee Structure" class="w-100">
          ...
          <div class="academics-left">
            <div class="ac-category">
              ...
              <ul>
                ...
                <li><a href="fee-structure.php"  class="active" title="Fee Structure">Fee Structure</a></li>
