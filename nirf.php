...
<head>
  ...
  <title> NIRF | Shobhit University</title>
    ...
    <div class="container">
      <div class="banner-spacing">
        <div class="section-info">
          ...
          <h1 data-aos="fade-up" data-aos-delay="100">National Institutional Ranking Framework</h1>
      ...
      <div class="row">
        <div class="col-lg-9">
          <div class="ac-overview">
            <div class="pera-dec">
             <h2>NIRF Management 2025</h2>
             <ul>
              <li>
                <p><a href="https://www.shobhituniversity.ac.in/pdf/nirf/NIRF-Management-Data-Successfully-Submitted-Shobhit-University20250109.pdf" target="_blank">NIRF Management</a></p>
              </li>
             </ul>
             <h2>NIRF SDG 2025</h2>
             <ul>
              <li>
                <p><a href="https://www.shobhituniversity.ac.in/pdf/nirf/NIRF_SDG_Data_Successfully_Submitted_Shobhit_University20250118.pdf" target="_blank">SDG INSTITUTION</a></p>
              </li>
             </ul>
            </div>
          </div>
