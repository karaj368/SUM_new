...
<head>
  ...
  <title>Research Policy | Shobhit University</title>
    ...
    <div class="container">
      <div class="banner-spacing">
        <div class="section-info">
          <h1 data-aos="fade-up" data-aos-delay="100"> Research Policy </h1>
      ...
      <div class="row">
        <div class="col-lg-9">
          <div class="ac-overview">
            <div class="pera-dec">
              <h3>University Research Policy:</h3>
             <p class="mt-3"><strong>1. University Research Policy <a href="https://www.shobhituniversity.ac.in/pdf/ssr/c3/univ-res-policy.pdf" target="_blank">Click Here</a></strong></p> 
