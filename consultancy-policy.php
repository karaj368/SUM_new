...
<head>
  ...
  <title>University Consultancy Policy | Shobhit University</title>
    ...
    <div class="container">
      <div class="banner-spacing">
        <div class="section-info">
          <h1 data-aos="fade-up" data-aos-delay="100"> University Consultancy Policy </h1>
      ...
      <div class="row">
        <div class="col-lg-9">
          <div class="ac-overview">
            <div class="pera-dec">
              <h3>University Consultancy Policy:</h3>
             <p class="mt-3"><strong>1. University Consultancy Policy <a href="https://www.shobhituniversity.ac.in/pdf/consultancypolicy.pdf" target="_blank">Click Here</a></strong></p> 
        ...
        <div class="col-lg-3">
          <div class="academics-left">
            <div class="ac-category">
              ...
              <ul>
                <li><a href="research-overview.php" title="Research Overview">Research Overview </a></li>
