...
<head>
 ...
 <title>Event Details | Shobhit University</title>
    ...
    <div class="container">
      <div class="banner-spacing">
        <div class="section-info">
          <h1 data-aos="fade-up" data-aos-delay="100"> Single Event Details </h1>
                    ...
                    <div class="col-lg-4">
                        <div class="widget-area">
                            ...
                            <div class="widget widget-catagories">
                                ...
                                <ul>
                                    <li><h4><a href="#">Admission</a></h4></li>
                                    <li><h4><a href="#">Alumni</a></h4> </li>
                                    <li><h4><a href="#">Career</a></h4> </li>
                                    <li><h4><a href="#">Research</a></h4> </li>
                                    <li><h4><a href="#">Spotlight</a></h4> </li>
                                </ul>
                            ...
                            <div class="widget widget-tags p-0">
                                ...
                                <div class="course-widget-area course-detail-rs-form m-0" >
                        <div class="content">
